...
_2b.height="100%";
_2b.width=_2a;
_2b.filter="progid:DXImageTransform.Microsoft."+"AlphaImageLoader(src='"+_2.basePath+"../images/wmd/bg-fill.png',sizingMethod='scale')";
_2b.position="absolute";
_33.appendChild(_34);
if(_32){
_2b.left="0";
...
if(!_2c){
_2b.backgroundImage="url("+_2.basePath+"../images/wmd/bg-fill.png)";
...
_e1();
_6.skin(_b8,_2.basePath+"../images/wmd/bg.png",_b2,_b3);
...
_b8.appendChild(_b9);
_cd(_8.autoindent);
var _e8=_6.createImage("../images/wmd/bg.png");
var _e9=_6.createImage("../images/wmd/bg-fill.png");
_e2();
_d9();
if(_bd){
_d0();

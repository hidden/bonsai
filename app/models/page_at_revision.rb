class PageAtRevision < Page
  ...
  def resolve_part part_name
    ...
    latest_part_revision = PagePartRevision.first(:joins => {:page_part => :page}, :conditions => [condition, self.lft, part_name, false, self.revision_date], :order => "pages.lft DESC, created_at DESC")
